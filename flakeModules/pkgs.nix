      ...
      perSystem = mkPerSystemOption ({
        ...
        pkgsSubmodule = submodule {
          options = foldl' recursiveUpdate {} [
            ...
            (mkPkg "bech32" caPkgs."bech32-input-output-hk-cardano-node-10-2-0-c4d675b")
            ...
            (mkPkg "cardano-cli" (caPkgs."cardano-cli-input-output-hk-cardano-node-10-2-0-c4d675b" // {version = "10.3.0.0";}))
            (mkPkg "cardano-cli-ng" (caPkgs."cardano-cli-input-output-hk-cardano-node-10-2-0-c4d675b" // {version = "10.3.0.0";}))
            ...
            (mkPkg "cardano-node" (caPkgs."cardano-node-input-output-hk-cardano-node-10-2-0-c4d675b" // {version = "10.2.0";}))
            (mkPkg "cardano-node-ng" (caPkgs."cardano-node-input-output-hk-cardano-node-10-2-0-c4d675b" // {version = "10.2.0";}))
            ...
            (mkPkg "cardano-submit-api" caPkgs."cardano-submit-api-input-output-hk-cardano-node-10-2-0-c4d675b")
            (mkPkg "cardano-submit-api-ng" caPkgs."cardano-submit-api-input-output-hk-cardano-node-10-2-0-c4d675b")
            (mkPkg "cardano-testnet" caPkgs."cardano-testnet-input-output-hk-cardano-node-10-2-0-c4d675b")
            (mkPkg "cardano-testnet-ng" caPkgs."cardano-testnet-input-output-hk-cardano-node-10-2-0-c4d675b")
            (mkPkg "cardano-tracer" caPkgs."cardano-tracer-input-output-hk-cardano-node-10-2-0-c4d675b")
            (mkPkg "cardano-tracer-ng" caPkgs."cardano-tracer-input-output-hk-cardano-node-10-2-0-c4d675b")
            ...
            (mkPkg "db-analyser" caPkgs."db-analyser-input-output-hk-cardano-node-10-2-0-c4d675b")
            (mkPkg "db-analyser-ng" caPkgs."db-analyser-input-output-hk-cardano-node-10-2-0-c4d675b")
            (mkPkg "db-synthesizer" caPkgs."db-synthesizer-input-output-hk-cardano-node-10-2-0-c4d675b")
            (mkPkg "db-synthesizer-ng" caPkgs."db-synthesizer-input-output-hk-cardano-node-10-2-0-c4d675b")
            (mkPkg "db-truncater" caPkgs."db-truncater-input-output-hk-cardano-node-10-2-0-c4d675b")
            (mkPkg "db-truncater-ng" caPkgs."db-truncater-input-output-hk-cardano-node-10-2-0-c4d675b")
            ...
            (mkPkg "mithril-client-cli-ng" (recursiveUpdate caPkgs.mithril-client-cli-input-output-hk-mithril-unstable-4ee78f3 {meta.mainProgram = "mithril-client";}))
            ...
            (mkPkg "mithril-signer-ng" (recursiveUpdate caPkgs.mithril-signer-input-output-hk-mithril-unstable-4ee78f3 {meta.mainProgram = "mithril-signer";}))
