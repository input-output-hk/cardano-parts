      ...
      perSystem = mkPerSystemOption ({
        ...
        pkgsSubmodule = submodule {
          options = foldl' recursiveUpdate {} [
            ...
            (mkPkg "cardano-db-sync-ng" (caPkgs.cardano-db-sync-input-output-hk-cardano-db-sync-sancho-2-1-0 // {exeName = "cardano-db-sync";}))
            ...
            (mkPkg "cardano-smash-ng" caPkgs.cardano-smash-server-no-basic-auth-input-output-hk-cardano-db-sync-sancho-2-1-0)
