      ...
      perSystem = mkPerSystemOption ({
        ...
        pkgsSubmodule = submodule {
          options = foldl' recursiveUpdate {} [
            ...
            (mkPkg "cardano-db-sync-ng" (caPkgs.cardano-db-sync-input-output-hk-cardano-db-sync-sancho-2-0-1 // {exeName = "cardano-db-sync";}))
            (mkPkg "cardano-db-tool" caPkgs.cardano-db-tool-input-output-hk-cardano-db-sync-13-1-1-3)
            (mkPkg "cardano-db-tool-ng" caPkgs.cardano-db-tool-input-output-hk-cardano-db-sync-sancho-2-0-1)
            ...
            (mkPkg "cardano-smash-ng" caPkgs.cardano-smash-server-no-basic-auth-input-output-hk-cardano-db-sync-sancho-2-0-1)
