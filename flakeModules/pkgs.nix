      ...
      perSystem = mkPerSystemOption ({
        ...
        pkgsSubmodule = submodule {
          options = foldl' recursiveUpdate {} [
            ...
            (mkPkg "mithril-client-cli-ng" (recursiveUpdate caPkgs.mithril-client-cli-input-output-hk-mithril-unstable-b4ac654 {meta.mainProgram = "mithril-client";}))
            ...
            (mkPkg "mithril-signer-ng" (recursiveUpdate caPkgs.mithril-signer-input-output-hk-mithril-unstable-b4ac654 {meta.mainProgram = "mithril-signer";}))
