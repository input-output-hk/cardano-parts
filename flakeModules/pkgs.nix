      ...
      perSystem = mkPerSystemOption ({
        ...
        pkgsSubmodule = submodule {
          options = foldl' recursiveUpdate {} [
            ...
            (mkPkg "cardano-db-sync-ng" (caPkgs."\"cardano-db-sync:exe:cardano-db-sync\"-input-output-hk-cardano-db-sync-sancho-4-1-0-d249be0" // {exeName = "cardano-db-sync";}))
            (mkPkg "cardano-db-tool" caPkgs."\"cardano-db-tool:exe:cardano-db-tool\"-input-output-hk-cardano-db-sync-13-2-0-1-ba77cf2")
            (mkPkg "cardano-db-tool-ng" caPkgs."\"cardano-db-tool:exe:cardano-db-tool\"-input-output-hk-cardano-db-sync-sancho-4-1-0-d249be0")
            ...
            (mkPkg "cardano-smash-ng" caPkgs.cardano-smash-server-no-basic-auth-input-output-hk-cardano-db-sync-sancho-4-1-0-d249be0)
            ...
            (mkPkg "db-analyser-ng" caPkgs."db-analyser-input-output-hk-cardano-node-8-10-0-pre-04e060e")
            (mkPkg "db-synthesizer" caPkgs."db-synthesizer-input-output-hk-cardano-node-8-9-2-424983f")
            (mkPkg "db-synthesizer-ng" caPkgs."db-synthesizer-input-output-hk-cardano-node-8-10-0-pre-04e060e")
            (mkPkg "db-truncater" caPkgs."db-truncater-input-output-hk-cardano-node-8-9-2-424983f")
            (mkPkg "db-truncater-ng" caPkgs."db-truncater-input-output-hk-cardano-node-8-10-0-pre-04e060e")
