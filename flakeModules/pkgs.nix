      ...
      perSystem = mkPerSystemOption ({
        ...
        pkgsSubmodule = submodule {
          options = foldl' recursiveUpdate {} [
            ...
            (mkPkg "bech32" caPkgs."bech32-input-output-hk-cardano-node-8-9-0-223c714")
            ...
            (mkPkg "cardano-cli" (caPkgs."cardano-cli-input-output-hk-cardano-node-8-9-0-223c714" // {version = "8.20.3.0";}))
            ...
            (mkPkg "cardano-node" (caPkgs."cardano-node-input-output-hk-cardano-node-8-9-0-223c714" // {version = "8.9.0";}))
            ...
            (mkPkg "cardano-submit-api" caPkgs."cardano-submit-api-input-output-hk-cardano-node-8-9-0-223c714")
            (mkPkg "cardano-submit-api-ng" caPkgs."cardano-submit-api-input-output-hk-cardano-node-8-9-1-da945ea")
            (mkPkg "cardano-tracer" caPkgs."cardano-tracer-input-output-hk-cardano-node-8-9-0-223c714")
            ...
            (mkPkg "db-analyser" caPkgs."db-analyser-input-output-hk-cardano-node-8-9-0-223c714")
            (mkPkg "db-analyser-ng" caPkgs."db-analyser-input-output-hk-cardano-node-8-9-1-da945ea")
            (mkPkg "db-synthesizer" caPkgs."db-synthesizer-input-output-hk-cardano-node-8-9-0-223c714")
            (mkPkg "db-synthesizer-ng" caPkgs."db-synthesizer-input-output-hk-cardano-node-8-9-1-da945ea")
            (mkPkg "db-truncater" caPkgs."db-truncater-input-output-hk-cardano-node-8-9-0-223c714")
